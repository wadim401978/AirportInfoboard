...
<c:set value="en" var="loc"/><fmt:setLocale value="${lang.langTag}"/><fmt:setBundle basename="viewer" var="viewer_bundle"/>
...
<ui:html locale="${lang.langTag}" title="${title}" hasNavbar="${hasNavbar}" ><%@page contentType="text/html" pageEncoding="UTF-8"%>
    <ui:timeOutForm/>
    <ui:table locale="${lang.langTag}" flights="${departures}"/>
</ui:html>
